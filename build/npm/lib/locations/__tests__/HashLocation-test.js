...
describe("HashLocation.getCurrentPath", function () {
  ...
  it("returns a properly decoded equivalent of window.location.hash", function () {
    ...
    window.location.hash = "complicated+string/full%2Fof%3Fspecial%25chars%2520and%23escapes%E1%88%B4";
    expect(HashLocation.getCurrentPath()).toBe("complicated+string/full%2Fof%3Fspecial%chars%20and%23escapesሴ");
  });
});